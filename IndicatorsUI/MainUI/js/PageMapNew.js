...
function goToMapPage() {
    ...
    if (groupRoots.length == 0) {
        ...
        //var html = "<div id='app_map'><div app-root >loading</div></div>";
        //var html = "<button id='TestButton' onclick='callAngularEvent();' >Test it!</button>";
...
function callAngularEvent() {
    var event = new CustomEvent('MapEnvReady-Event', { 'detail': true });
