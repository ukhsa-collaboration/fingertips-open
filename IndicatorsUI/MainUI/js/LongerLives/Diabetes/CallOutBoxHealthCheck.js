...
var content = '<h4 class="diabetes-place-name">{{nameofplace}}</h4>' +
        ...
        '</div>' + line +
        '{{#isHealthChecksDomain}}' + indicator1Content + indicator2Content + indicator3Content + '{{/isHealthChecksDomain}}' +
        '{{^isHealthChecksDomain}}' + selectedIndicatorContent + '{{/isHealthChecksDomain}}';
