...
namespace IndicatorsUI.MainUITest.Controllers
{
    ...
    public class UserAccountControllerTest
    {
        ...
        public void Test_Sign_In_Without_Registered_Email_Address()
        {
            ...
            var result = (ViewResult) controller.ValidateLogin(viewModel, null).Result;
        ...
        {
            // Arrange: email sent successfully
            _emailSender.Setup(x => x.SendVerificationEmail(It.IsAny<string>(), It.IsAny<string>(),
                It.IsAny<Guid>()));
        ...
        {
            // Arrange: email could not be sent
            _emailSender.Setup(x => x.SendVerificationEmail(It.IsAny<string>(), It.IsAny<string>(),
                It.IsAny<Guid>())).Throws<Exception>();
        ...
        private UserAccountController GetController()
        {
            return new UserAccountController(_identityWrapper.Object, _userAccessDbContext.Object,
                _emailSender.Object, _exceptionLogger.Object, _userAccountHelper.Object,
                _appConfig.Object);
        }
