    ...
    public class SpcForProportionsComparerTest
    {
        ...
        public void TestComparisionWithDifferentConfidencesWhereSignifancesSame()
        {
            ...
            CoreDataSet data = new CoreDataSet
            {
                ...
                LowerCI95 = 7.0548320523366375,
                UpperCI95 = 8.4130813590727076,
                Denominator = 5930,
                YearRange = 1
            };
            ...
            data = new CoreDataSet
            {
                ...
                LowerCI95 = 8.7379055891773572,
                UpperCI95 = 11.195035154784872,
                Denominator = 2273,
                YearRange = 1
            };
            ...
            data = new CoreDataSet
            {
                ...
                LowerCI95 = 11.088798553603118,
                UpperCI95 = 14.006406155616993,
                Denominator = 1972,
                YearRange = 1
            };
        ...
        public void TestComparisionWithDifferentConfidencesWhereSignifancesDifferent()
        {
            ...
            CoreDataSet data = new CoreDataSet
            {
                ...
                LowerCI95 = 9.41418865607498,
                UpperCI95 = 12.7657535004819,
                Denominator = 1339,
                YearRange = 1
            };
            Assert.AreEqual(Significance.Better, New95_0().Compare(data, comparator, metadata));
            ...
            data = new CoreDataSet
            {
                ...
                LowerCI95 = 13.6615426206213,
                UpperCI95 = 18.4417082867185,
                Denominator = 899,
                YearRange = 1
            };
            Assert.AreEqual(Significance.Worse, New95_0().Compare(data, comparator, metadata));
