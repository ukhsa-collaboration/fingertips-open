...
namespace PholioVisualisation.ServicesWeb
{
    ...
    /// <summary>
    /// Removes deprecated operations from the documentation.
    /// </summary>
    public class FingertipsApiDocumentFilter : IDocumentFilter
    {
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        // Obsolete used to remove unwanted controllers on live
