...
namespace PholioVisualisation.DataSortingTest
{
    ...
    public class CoreDataSetFilterTest
    {
        ...
        [TestMethod]
        public void TestSelectWithAreaCodes()
        {
            var codes = new[] { "a", "b" };
            var filteredData = new CoreDataSetFilter(TestData()).SelectWithAreaCodes(codes);
        ...
        {
            var filteredData = new CoreDataSetFilter(TestData()).SelectWithAreaCodes(new string[] { });
            Assert.AreEqual(3, filteredData.Count());
        }

        [TestMethod]
        public void TestSelectWithAreaCodesIgnoresNullListOfAreaCodes()
        {
            var filteredData = new CoreDataSetFilter(TestData()).SelectWithAreaCodes(null);
            Assert.AreEqual(3, filteredData.Count());
        }
        ...
        {
            var filteredData = new CoreDataSetFilter(TestData()).SelectWithAreaCode("a");
            Assert.AreEqual("a", filteredData.AreaCode);
        }

        [TestMethod]
        public void TestRemoveWithAreaCode()
        {
            var codes = new[] { "a", "b" };
        ...
        [TestMethod]
        public void TestRemoveWithAreaCodeCaseInsensitive()
        {
            // WRT ignored codes
        ...
        [TestMethod]
        public void TestRemoveWithAgeId()
        {
            var filteredData = new CoreDataSetFilter(TestData()).RemoveWithAgeId(new List<int> { 1 });
            Assert.AreEqual(2, filteredData.Count());
        }
        ...
        public IEnumerable<CoreDataSet> TestData()
        {
            return new[]
                {
                    new CoreDataSet{AreaCode = "a", AgeId = 1},
                    new CoreDataSet{AreaCode = "b", AgeId = 2},
                    new CoreDataSet{AreaCode = "c", AgeId = 3}
                };
        }
