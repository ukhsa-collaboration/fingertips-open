...
{
    public class IndicatorMetadataRepository
    {
        ...
        /// Private constructor
        /// </summary>
        private IndicatorMetadataRepository() { }

        public static IndicatorMetadataRepository Instance
        {
            get
            {
                //No cache option
                return new IndicatorMetadataRepository();
            }
        }
        ...
        {
            return new IndicatorMetadataCollection(GetIndicatorMetadata(groupings));
        }
