...
namespace PholioVisualisation.ExportTest.FileBuilder.Writers
{
    ...
    public class CsvBuilderIndicatorDataBodyPeriodWriterTest
    {
        ...
        public void Start()
        {
            ...
            _onDemandQueryParameters = new OnDemandQueryParametersWrapper(1, new List<int>{1}, new Dictionary<int, IList<Inequality>> { { IndicatorIds.MrsaBacteraemiaRates, null } });
        ...
        public void ShouldWritePeriodsForIndicatorBodyInFile()
        {
            ...
            {
                Age = new Age(), AreaTypeId  = 1, AgeId = 1, BaselineYear = 1, YearRange = 1, IndicatorId = 1, Sequence = 1, GroupId = 1, SexId = 1, BaselineMonth = 1, BaselineQuarter = 1,
                ComparatorConfidence = 1, ComparatorData = _coreDataSetEnglandTest, ComparatorId = 1, ComparatorMethodId = 1, ComparatorTargetId = 1, DataPointMonth = 1, DataPointQuarter = 1,
                DataPointYear = 1, GroupingId = 1, PolarityId = 1, Sex = new Sex(), TimePeriodText = "periodTextTest"
            };
            ...
            var bodyPeriodWriterContainer = new CsvBuilderIndicatorDataBodyPeriodWriter(_indicatorMetadata, groupingMock, _areaHelper, groupDataReaderMock.Object, _generalParameters, _onDemandQueryParameters);

            try
            {
                bodyPeriodWriterContainer.WritePeriodsForIndicatorBodyInFile(indicatorId, ref _singleIndicatorFileWriter);
            }
            catch (Exception)
            {
