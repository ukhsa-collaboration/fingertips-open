...
{
    [TestClass]
    public class CsvBuilderIndicatorDataHeaderWriterTest
    {
        ...
        [TestMethod]
        public void ShouldReturnExpectedHeaderTest()
        {
            var csvBuilderIndicatorDataHeaderWriter = new CsvBuilderIndicatorDataHeaderWriter(_areasReaderMock.Object, _generalParameters);

            try
            {
                var result = csvBuilderIndicatorDataHeaderWriter.GetHeader();
